...
> **文档类型**：早期 **Korvo S3** 综合验板/多页 UI 笔记。  
> **请优先阅读**：[Korvo korvo_board_test](./Korvo例程详解-korvo_board_test.md) · [P4C5 p4c5_board_test](./P4C5例程详解-p4c5_board_test.md)

# ESP32-S3 综合硬件测试（通用笔记）
