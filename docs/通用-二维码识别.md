...
> **文档类型**：早期 **Korvo S3** 二维码笔记。
> **请优先阅读**：[Korvo qrcode](./Korvo例程详解-qrcode_detection.md) · [P4C5 qrcode](./P4C5例程详解-qrcode_detection.md)
...
```c:Korvo_Firmware\29.lvgl_qrcode_detect\main\app_camera.c
...
```c:Korvo_Firmware\29.lvgl_qrcode_detect\main\app_camera.h
...
```c:Korvo_Firmware\29.lvgl_qrcode_detect\main\page_cam.c
#include "page_cam.h"
#include "stdio.h"
#include <stdlib.h>
#include <string.h>
...
```c:Korvo_Firmware\29.lvgl_qrcode_detect\main\app_main.c
...
```yaml:Korvo_Firmware\29.lvgl_qrcode_detect\main\idf_component.yml
dependencies:
